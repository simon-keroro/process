...
const routes = [
  {id:"no-pay",label:"不涉及付款",range:"无需付款",summary:"合同文本先经法务审核，再发起合同会签并完成备案。",steps:[
    s("合同文本预审与会签","申请人 / 黄海老师","OA",["合同文本（先发法务老师审核）","对方营业执照"],"OA 新建事项发黄海老师，仅走合同会签。"),
    s("打印会签单并备案","申请人","线下",["合同订立会签单"],"完成合同备案。","线下")
  ]},
  {id:"under-10",label:"10 万元以内",range:"涉及付款 · 10 万元以内",summary:"以询价为核心，完成采购审批、合同签订、付款审批与报账。",steps:[
    s("采购事项审批","申请人 / 研发中心","OA",["研发中心采购事项审批表"],"此金额区间不需要研发中心审批。"),
    s("询价审批与供应商核验","申请人","OA",["三家报价单","各公司营业执照","关联方关系截图","采购事项审批表"],"检查供应商注册/准入；未完成时先走供应商注册、准入审批。信用信息在国家企业信用信息公示系统查询。"),
    s("合同会签","申请人 / 黄海老师","OA",["合同","乙方营业执照","采购事项审批表","询价审批单"],"询价审批单上传后即可联系 CRO 准备合同，并请唐玲老师协助审核。"),
    s("签字、签章与备案","梁总 / 申请人","线下",["询价审批单","合同订立会签单","反商业贿赂承诺书"],"梁总（409）签字；办公楼 2 楼盖章备案。填写签订日、终止期及备注，有效期早于签订期一天。","线下"),
    s("费用报销 / 支付审批","申请人 / 研发中心","OA",["签章合同","采购事项审批表","成果交付确认表 PDF（如已有）"],"如已走成果交付结果确认表，无需重复上传报告。"),
    s("合同付款","申请人 / 黄海老师","OA",["签章合同电子版","乙方营业执照","费用报销 / 支付审批单"],commonPaymentNote),
    s("通用报销单付款","申请人 / 财务处","智慧报账",["合同付款单","签章合同","发票","可交付结果确认表（如已有）","支付审批单"],"勾选发票报销，打印封面与附件，交行政楼 3 楼财务处。","智慧报账")
  ]},
  {id:"10-50",label:"10–50 万元",range:"涉及付款 · 10 万以上 50 万以内",summary:"进入招议标流程，但无需研发中心请示，采购事项审批选择“不需要研发中心审批”。",steps:bidSteps(false)},
  {id:"50-100",label:"50–100 万元",range:"涉及付款 · 50 万以上 100 万以内",summary:"需要研发中心请示并完成招议标、定标、经营类请示后再签合同。",steps:bidSteps(true)},
  {id:"100-500",label:"100–500 万元",range:"涉及付款 · 100 万以上 500 万以内",summary:"需要血制公司与研发中心审批，并转入天坛集中采购和招标。",steps:[
    s("研发中心请示","申请人 / 研发中心","OA",["研发中心请示处理笺","请示文件（附件 2）"]),
    s("蓉生经营类请示","申请人","OA",["蓉生经营类请示"]),
    s("采购事项审批","申请人 / 研发中心","OA",["采购事项审批表","研发中心请示处理笺","蓉生经营类请示"],"选择需要“血制公司审批”和“研发中心审批”。"),
    s("血制公司集中采购申请","申请人","OA",["集中采购申请表","用户需求 Word","用户需求 PDF 签章版（蓝色笔签字）","前三项审批材料"],"需切换至蓉生 OA 系统。"),
    s("等待招标与中标通知","天坛 / 招采","外部等待",["中标通知"],"等待时间通常较长且不可控。","外部"),
    s("合同会签","申请人 / 黄海老师","OA",["合同","乙方营业执照","中标通知","研发中心请示处理笺","蓉生经营类请示","采购事项审批表"]),
    s("合同签章与备案","申请人","线下",["蓉生经营类请示","合同订立会签单","反商业贿赂承诺书"],"办公楼 2 楼办理。","线下"),
    s("成果确认与支付审批","申请人 / 研发中心","OA",["成果可交付确认表","签章版报告（按合同判断）","合同发票","签章合同","采购事项审批表"]),
    s("合同付款","申请人 / 黄海老师","OA",["签章合同电子版","电子版发票","乙方营业执照","支付审批单"],commonPaymentNote),
...
function bidSteps(needsRequest){
  const arr=[];
  if(needsRequest) arr.push(s("研发中心请示","申请人 / 研发中心","OA",["研发中心请示处理笺","请示文件（附件 2）"]));
  arr.push(
    s("采购事项审批","申请人 / 研发中心","OA",["采购事项审批表"],needsRequest?"选择需要研发中心审批。":"50 万以内选择不需要研发中心审批。"),
    s("招议标审核登记","申请人 / 招采","OA",["招议标文件 Word（附件 3）","用户需求 Word 与 PDF 签章版（附件 4）","综合评分细则 Word（附件 5）","关联方关系截图"],"用户需求 PDF 需蓝色笔签字；仅一家供应商时可上传工商信息。"),
    s("提交评标材料并等待定标","田怡老师 / 招采","外部等待",["招议标审核登记表","URS","招议标文件","评分表","采购事项审批表",...(needsRequest?["请示"]:[]),"关联方截图"],"纸质材料交行政楼 304 田怡老师；等待评标及定标请示。项目名称须与 URS 一致。","线下"),
    s("蓉生经营类请示","申请人","OA",["采购请示（附件 6）","定标请示"],"关联田怡老师发送的定标请示；流程中由田怡老师附言添加中标通知书。"),
    s("合同会签","申请人 / 黄海老师","OA",["合同","乙方营业执照","中标通知",...(needsRequest?["研发中心请示处理笺"]:[]),"采购事项审批表","蓉生经营类请示"]),
    s("合同签章与备案","申请人","线下",["蓉生经营类请示","合同订立会签单","反商业贿赂承诺书"],"办公楼 2 楼办理。","线下"),
    s("成果确认与支付审批","申请人 / 研发中心","OA",["成果可交付确认表","签章版报告（按合同判断）","合同发票","签章合同","采购事项审批表"]),
    s("合同付款","申请人 / 黄海老师","OA",["签章合同电子版","电子版发票","乙方营业执照","支付审批单"],commonPaymentNote),
    s("智慧报账付款","申请人 / 财务处","智慧报账",["合同付款单","签章合同","发票","支付审批单"],"完成付款流程。","智慧报账")
